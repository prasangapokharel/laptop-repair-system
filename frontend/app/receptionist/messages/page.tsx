...
export default function ReceptionistMessagesPage() {
  ...
  // Fetch customers and technicians for recipient dropdown
  const { data: customers, loading: customersLoading } = useCustomers(100, 0)
  const { data: technicians, loading: techniciansLoading } = useTechnicians(100, 0)
  
  const allRecipients = [...customers, ...technicians]
        ...
        <div className="flex flex-1 flex-col gap-4 p-4">
          <Breadcrumb
            items={[
              ...
              { label: "Messages", href: "/receptionist/messages" },
            ]}
          />
            ...
            <Dialog open={showCompose} onOpenChange={setShowCompose}>
              ...
              <DialogContent className="sm:max-w-[525px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Send a message to a customer or technician
                  </DialogDescription>
                </DialogHeader>
              ...
              {selectedMessage.order && (
                <div className="grid gap-2">
                  ...
                  <Button
                    ...
                    onClick={() => router.push(`/receptionist/orders/${selectedMessage.order?.id}/view`)}
                  >
