...
export default function TechnicianMessagesPage() {
  ...
  // Fetch customers for recipient dropdown (technicians mainly message customers and receptionists)
        ...
        <div className="flex flex-1 flex-col gap-4 p-4">
          <Breadcrumb
            items={[
              ...
              { label: "Messages", href: "/technician/messages" },
            ]}
          />
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">
                Communicate with customers and receptionists
              </p>
            </div>
            <Dialog open={showCompose} onOpenChange={setShowCompose}>
              ...
              <DialogContent className="sm:max-w-[525px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Send a message to a customer or receptionist
                  </DialogDescription>
                </DialogHeader>
              ...
              {selectedMessage.order && (
                <div className="grid gap-2">
                  ...
                  <Button
                    ...
                    onClick={() => router.push(`/technician/orders/${selectedMessage.order?.id}/view`)}
                  >
