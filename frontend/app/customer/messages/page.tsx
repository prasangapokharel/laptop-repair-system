...
export default function CustomerMessagesPage() {
  ...
  const [messageType, setMessageType] = useState<"Query" | "Advice" | "Status Update" | "General">("Query")
  ...
  // Fetch technicians for recipient dropdown (customers mainly message technicians and receptionists)
  const { data: technicians, loading: techniciansLoading } = useTechnicians(100, 0)
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">
                Contact support or ask questions about your repairs
              </p>
            </div>
            <Dialog open={showCompose} onOpenChange={setShowCompose}>
              ...
              <DialogContent className="sm:max-w-[525px]">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Contact support staff about your device or repair
                  </DialogDescription>
                </DialogHeader>
                <div className="grid gap-4 py-4">
                  <div className="grid gap-2">
                    ...
                    <Select value={recipientId} onValueChange={setRecipientId}>
                      ...
                      <SelectContent>
                        <SelectItem value="" disabled>Select a recipient</SelectItem>
              ...
              {selectedMessage.order && (
                <div className="grid gap-2">
                  ...
                  <Button
                    ...
                    onClick={() => router.push(`/customer/orders/${selectedMessage.order?.id}/view`)}
                  >
