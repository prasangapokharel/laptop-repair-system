...
export function LoginForm({
  ...
  function routeForRole(roleName?: string | null) {
    ...
    if (name === "receptionist" || name === "reception") return "/receptionist/dashboard"
    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      ...
      <Card className="overflow-hidden border-0 shadow-lg">
        <CardContent className="grid p-0 md:grid-cols-2">
              ...
              <Field>
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    disabled={loading}
                    className="h-10 bg-muted/50 border-muted text-sm"
                  />
                </div>
              </Field>
              ...
              <Field>
                ...
                <div className="relative">
                  <Input
                    ...
                    required
                    disabled={loading}
                    className="h-10 bg-muted/50 border-muted text-sm pr-10"
                  />
                  <button
                    type="button"
          ...
          {/* Image Section */}
          <div className="bg-gradient-to-br from-primary/10 via-primary/5 to-transparent relative hidden md:flex items-center justify-center p-8">
            ...
            <div className="relative z-10 text-center space-y-4">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-lg bg-primary/10 backdrop-blur-sm border border-primary/20">
                <svg
