...
const data = {
  navMain: [
    { title: "Dashboard", url: "/accountant/dashboard", icon: IconDashboard },
    { title: "Payments", url: "/accountant/payments", icon: IconCash },
    { title: "Orders", url: "/accountant/orders", icon: IconClipboardList },
  ],
  documents: [
    { name: "Reports", url: "/accountant/reports", icon: IconReport },
  ],
  navSecondary: [
